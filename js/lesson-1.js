...
//  Напиши цикл от 1 до 30, но пропусти все числа, содержащие цифру "3" (например, 3, 13, 23).
...
// Задача: Напиши цикл от 1 до 50.
// Выводи только нечетные числа.
// Но если число делится на 7 без остатка, остановись (break).  Используй continue для пропуска четных чисел
...
// 3. Игнорируем отрицательные числа
// Задача: Дан массив чисел, например: [5, -2, 8, -1, 10, -6, 15].
// Выведи только положительные числа.
// Используй логику от обратного.

// const numbers = [5, -2, 8, -1, 10, -6, 15];
...
// Найти первое число, делящееся на 5 и 3 одновременно
// Задача:
// Пройдись по числам от 1 до 100.
// Найди первое число, которое делится и на 5, и на 3 (num % 5 === 0 && num % 3 === 0).
// Как только найдешь — останови цикл(break).
